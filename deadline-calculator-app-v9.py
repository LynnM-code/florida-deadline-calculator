...
user_key_input = st.sidebar.text_input(
    ...
    type="password",
    help="Enter the license key to unlock client summaries, chronological roadmaps, and plain-text copy-paste templates."
)

# Set up Premium session state
...
# -----------------------------------------------------------------------------------------
# TAB 2: SIMPLIFIED CHRONOLOGICAL CLIENT SUMMARIES (PREMIUM LOCKED)
# -----------------------------------------------------------------------------------------
with tab2:
...
# -----------------------------------------------------------------------------------------
# Expose Download summary ONLY if premium is active
if is_premium_active:
    summary_text = f"FLORIDA REAL ESTATE CONTRACT DEADLINE CHRONOLOGICAL SUMMARY (V9.0)\n"
